...
<table cols="2">
    ...
    <tr>
        <td>Исходный код getAttribute.jsp:</td>
        <td>
    ...
    <tr>
        <td>Исходный код getAttribute(2).jsp:</td>
        <td>
            <div class="kotlin-code" data-highlight-only folded-button="true">
                <pre>
                    <code class="hljs language-text" id="ajaxDiva">
                    </code>
                </pre>
            </div>
        </td>
   ...
   <script>
        $( document ).ready(function() {
            ...
            $("#ajaxDiv"));
            codeLoad("<%=request.getContextPath()%>/sources/jsp-course/getAttribute(2).jsp",
            $("#ajaxDiva"));
        });           
</script>
</body>
