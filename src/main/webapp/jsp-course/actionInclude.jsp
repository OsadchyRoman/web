...
<table cols="2">
    ...
    <tr>
        <td>Исходный код :</td>
        <td>
            <iframe src="/sources/jsp-course/actionInclude.jsp" frameborder="1" width="1000" height="400"></iframe>
        </td>
    </tr>
    <tr>
        <td></td>
        <td><button class="button-source"><a href="/sources/jsp-course/actionInclude.jsp"  target="_blank">Показать в отдельной вкладке</a></button></td>
    </tr>
    <tr>
